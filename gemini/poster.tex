...
%%      \caption{A figure caption.}
  ...
  \begin{block}{Useful Definitions}
...
\heading{Commutators:}
If $g,h$ are two elements of a group G, then we call the element:
$$[g,h]=ghg^{-1}h^{-1}$$
...
\textbf{Remark 2:} 
\textbf{Commutators} provided us with a method for creating puzzles moves that affect only a small number of pieces. \textbf{Conjugation} is a process for modifying moves to produce new moves that have similar structure.
