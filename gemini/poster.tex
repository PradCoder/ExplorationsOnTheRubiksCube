...
exchanged from the starting position.
      ...
      \item \textbf{Second Fundamental Theorem of Cubology}An operation of the cube is possible if and only if the following are satisfied:
            \begin{itemize}
...
Similar to the corner twist, swapped pieces produces odd permutations.
    ...
    \begin{figure}
      ...
      \includegraphics{Screenshot from 2024-03-24 08-41-47.png}
      \caption{Corner twist}
    \end{figure}

    \begin{figure}
      \centering
      \includegraphics{Screenshot from 2024-03-24 08-42-10.png}
...
\begin{column}{\colwidth}
  ...
  \begin{exampleblock}{Construction of legal Rubik's cube}
    ...
    In this section, we will construct the legal Rubik's cube.
